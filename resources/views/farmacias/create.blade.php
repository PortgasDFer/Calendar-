...
<div class="main-content">
    <div class="section__content section__content--p30">
		<div class="container-fluid">
			<div class="col-lg-12">
                <div class="card">
                    <div class="card-header btn_2">Registrar farmacia</div>
                    <div class="card-body card-block">
                      <form action="/farmacias" method="POST" id="registro" enctype="multipart/form-data">
                          @csrf
                            <div class="form-group">
                                <label for="">Nombre de la farmacia</label>
                                <div class="input-group">
                                    <div class="input-group-addon">
                                        <i class="fa fa-user"></i>
                                    </div>
                                    <input type="text" id="nombreFarmacia" name="nombreFarmacia" placeholder="Nombre de la farmacia" class="form-control">
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="input-group">
                            ...
                            <div class="form-group row">
                                <div class="col-xs-12 col-sm-12 col-md-6">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" id="calle" name="calle" placeholder="Nombre de la calle" class="form-control">
                                    </div>
                                </div>
                                <div class="col-xs-12 col-sm-12 col-md-6">
                            ...
                            <div class="form-group row">
                                <div class="col-xs-12 col-sm-12 col-md-6">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" id="colonia" name="colonia" placeholder="Nombre de la colonia" class="form-control">
                                    </div>
                                </div>
                                <div class="col-xs-12 col-sm-12 col-md-6">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" id="cp" name="cp" placeholder="Código postal" class="form-control">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="col-xs-12 col-sm-12 col-md-6">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" id="municipio" name="municipio" placeholder="Nombre del municipio" class="form-control">
                                    </div>
                                </div>
                                <div class="col-xs-12 col-sm-12 col-md-6">
