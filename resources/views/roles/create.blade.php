			...
			<div class="col-lg-12">
                <div class="card btn_2">
                    ...
                    <div class="card-body card-block">
                        <form action="/roles" method="POST" id="registro">
                            @csrf
                            <div class="form-group">
                                <div class="input-group">
                                    ...
                                    <input type="text" id="rol" name="rol" placeholder="Nombre del Rol" class="form-control">
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="input-group">
                                    ...
                                    <input type="text" id="desc" name="desc" placeholder="Descripción" class="form-control">
                                </div>
                            </div>
